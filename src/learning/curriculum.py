...
NORMALIZED_SCORE_IDS = {
    ...
    "nose_axis_alignment",
    "nose_base_level",
    "nose_perspective_compression",
    "muzzle_support",
    "mouth_axis_alignment",
    "mouth_corner_coherence",
    "mouth_perspective_wrap",
    "mouth_within_muzzle",
    "ear_height_balance",
    "ear_attachment_balance",
    "ear_bowl_balance",
    "ear_level_balance",
    "near_ear_attachment",
    "near_ear_bowl",
    "ear_side_plane_alignment",
    "far_ear_occlusion_evidence",
    "nose_design_retention",
