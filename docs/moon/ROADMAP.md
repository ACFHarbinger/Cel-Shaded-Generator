...
host. Twenty-one slices are implemented, all In review: the first (issue #25 —
...
document), and the twenty-first (issue #53 — Import Image Layer loads a
dimension-matched RGBA image as a new undoable editable layer).
